...
// export class Two extends ListViewModel {
  data = [{
    text: 'All',
    value: '-1'
  },{
...
townChanged() {
  ...
  saveGrid(e) {
    ...
    // let opts = jQuery(this.grid).kendoGrid.getOptions
    // var grid =  jQuery(this.grid).kendoGrid.data// $("#grid").data("kendoGrid");
    // var options = grid.getOptions()
    // localStorage.setItem('kendo-grid-options', kendo.stringify(options)) //this.grid.getOptions))
